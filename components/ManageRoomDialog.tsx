...
export function ManageRoomDialog({
  ...
  initialName,
  initialDescription,
}: Readonly<ManageRoomDialogProps>) {
        ...
        {isConfirmingDelete ? (
          <div className="flex flex-col gap-4 mt-2">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              itself will be deleted permanently.
            </p>
          ...
          <>
            ...
            <form onSubmit={handleUpdate} className="flex flex-col gap-4 mt-4">
              ...
              <div className="flex flex-col gap-3 mt-4 pt-4 border-t border-border">
                <Button
                  type="submit"
                  className="w-full h-10 rounded-none bg-[#1A1A1A] text-white hover:bg-[#444444] transition-colors"
                  disabled={loading || deleting}
                >
