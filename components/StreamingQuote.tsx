...
const FALLBACK_QUOTES = [
  ...
  {
    text: "To read a poem is to hear it with our eyes; to hear it is to see it with our ears.",
    author: "Octavio Paz",
  },
  {
    text: "A book is a version of the world. If you do not like it, ignore it; or offer your own version in return.",
  ...
  return (
    <>
      <blockquote className="font-serif text-xl lg:text-2xl text-[#1A1A1A] leading-relaxed italic mb-6 min-h-[96px]">
        {formattedQuote}
        {isLoading && (
          <span className="inline-block w-1.5 h-6 ml-1 align-middle bg-[#1A1A1A]/80 animate-pulse" />
        )}
      </blockquote>
