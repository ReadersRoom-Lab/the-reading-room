          ...
          <SignUp
            ...
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: { backgroundColor: 'transparent', color: '#FDFBF7', borderColor: 'rgba(255, 255, 255, 0.2)' },
                formButtonPrimary: { backgroundColor: 'rgba(255, 255, 255, 0.9)', color: '#1A1A1A', border: 'none', borderRadius: '0px' },
                socialButtonsBlockButton: { color: '#FDFBF7', border: '1px solid rgba(255, 255, 255, 0.2)', backgroundColor: 'rgba(255, 255, 255, 0.03)', borderRadius: '0px' },
