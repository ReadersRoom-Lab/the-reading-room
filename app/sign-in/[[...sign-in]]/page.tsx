          ...
          <SignIn
            ...
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: { backgroundColor: 'rgba(255, 255, 255, 0.05)', color: '#FDFBF7', borderColor: 'rgba(255, 255, 255, 0.1)' },
                formButtonPrimary: { backgroundColor: '#FDFBF7', color: '#1A1A1A' },
                socialButtonsBlockButton: { color: '#FDFBF7', borderColor: 'rgba(255, 255, 255, 0.1)', backgroundColor: 'transparent' },
