        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-serif text-sm text-[#52525B]">
              Reflect on your reading activity, vocabulary vault growth, and search library links.
            </p>
          </div>
        </div>
      ...
      {activeTab === "chat" && (
        ...
        <div className="flex flex-col h-[calc(100vh-14rem)] w-full animate-in fade-in duration-300">
            ...
            <div className="flex flex-col gap-6">
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-center min-h-[360px] border border-[#E5E5E5] bg-white p-12 animate-in zoom-in-95 duration-200">
                  ...
                  <p className="font-heading text-2xl font-semibold text-[#1A1A1A] mb-2">
                    What would you like to explore?
                  </p>
                  <p className="font-sans text-sm text-[#52525B] max-w-md">
                    Try asking for a summary of your recent articles, or finding connections between
                    your saved concepts.
                  </p>
                </div>
              ) : (
          ...
          <form
            ...
            className="flex gap-0 border border-[#E5E5E5] bg-white items-center shrink-0"
          >
            <Input
              value={input}
