    ...
    <div className="max-w-2xl mx-auto py-6">
      ...
      <div className="mb-10">
        ...
        <p className="text-[#52525B] font-sans text-base leading-relaxed">
          Clip any article, blog post, or research paper directly into your library with a single
          click — no copy-pasting URLs needed.
        </p>
      </div>
      ...
      {/* Steps */}
      <div className="mb-10">
        <h2 className="font-heading font-bold text-xl text-[#1A1A1A] mb-6">
          ...
          {[
            {
              ...
              description:
                'Click "Download Extension" above. Once downloaded, extract (unzip) the folder to a permanent location on your computer.',
            },
            {
              number: "02",
              icon: Puzzle,
              ...
              codeNote:
                'Enable "Developer mode" toggle (top-right), click "Load unpacked", and select the unzipped folder.',
            },
            {
              number: "03",
              icon: Settings,
            ...
            return (
              <div key={step.number} className="flex gap-5 pb-8 last:pb-0 relative">
                ...
                <div className="flex flex-col gap-1 pt-2 min-w-0">
                  ...
                  {step.codeNote && (
                    <p className="font-sans text-xs text-[#52525B] leading-relaxed mt-1">
                      {step.codeNote}
                    </p>
                  )}
                </div>
      ...
      <div className="border border-dashed border-[#E5E5E5] p-5 bg-[#F9F7F2]">
        <p className="text-xs font-sans font-medium tracking-[0.1em] text-[#BDBDBD] uppercase mb-1">
          Coming soon
        </p>
