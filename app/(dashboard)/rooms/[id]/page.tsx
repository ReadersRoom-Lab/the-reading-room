...
import { RoomConceptsTab } from "@/components/RoomConceptsTab";
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-6xl mx-auto py-8 px-4 sm:px-6">
      ...
      <Tabs defaultValue="all" className="w-full flex-col">
        ...
        <TabsContent value="concepts" className="mt-0 outline-none">
          <RoomConceptsTab roomId={room.id} articleCount={room.articles.length} />
        </TabsContent>
      </Tabs>
    </div>
  );
