  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-6xl mx-auto py-8 px-6">
      ...
      <Tabs defaultValue="all" className="w-full flex-col">
        <TabsList className="mb-8 inline-flex h-auto items-center justify-start rounded-md bg-[#F4F3F3] p-1.5 text-muted-foreground w-fit border border-[#E5E5E5]/50">
          <TabsTrigger value="all" className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-5 py-2 text-[11px] font-bold uppercase tracking-[0.1em] transition-all data-[state=active]:bg-white data-[state=active]:text-[#1A1A1A] data-[state=active]:shadow-sm hover:text-[#1A1A1A] hover:bg-white/50 data-[state=active]:hover:bg-white">
            All ({room.articles.length})
          </TabsTrigger>
          <TabsTrigger value="unread" className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-5 py-2 text-[11px] font-bold uppercase tracking-[0.1em] transition-all data-[state=active]:bg-white data-[state=active]:text-[#1A1A1A] data-[state=active]:shadow-sm hover:text-[#1A1A1A] hover:bg-white/50 data-[state=active]:hover:bg-white">
            Unread ({unreadArticles.length})
          </TabsTrigger>
          <TabsTrigger value="in-progress" className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-5 py-2 text-[11px] font-bold uppercase tracking-[0.1em] transition-all data-[state=active]:bg-white data-[state=active]:text-[#1A1A1A] data-[state=active]:shadow-sm hover:text-[#1A1A1A] hover:bg-white/50 data-[state=active]:hover:bg-white">
            In Progress ({inProgressArticles.length})
          </TabsTrigger>
          <TabsTrigger value="completed" className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-5 py-2 text-[11px] font-bold uppercase tracking-[0.1em] transition-all data-[state=active]:bg-white data-[state=active]:text-[#1A1A1A] data-[state=active]:shadow-sm hover:text-[#1A1A1A] hover:bg-white/50 data-[state=active]:hover:bg-white">
